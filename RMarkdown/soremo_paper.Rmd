...
So, to restate the above, $V = \{v_1, \ldots, v_N\}$ denotes the precincts in the state, with rook-adjacency graph $G = (V, E)$. Let $\pi$ be a redistricting plan be a partition $V \to {1, \cdots, K}$ of $K$ districts. Let the redistricting plan being analyzed be denoted as $\pi_0$.
